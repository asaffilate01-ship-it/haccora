...
GRANT SELECT, INSERT, UPDATE ON public.high_risk_action_requests TO authenticated;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.backup_restore_drills TO authenticated;
GRANT ALL ON public.privacy_requests, public.device_sessions, public.security_events,
  public.high_risk_action_requests, public.retention_policies, public.legal_holds,
  public.file_scan_jobs, public.backup_restore_drills, public.webhook_replay_nonces,
