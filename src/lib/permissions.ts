...
export const ROLE_ACTIONS: Record<Role, Action[]> = {
  owner: [...ACTIONS],
  manager: [
    "records.export","records.signOff",
    "haccp.editPlan",
    "team.invite",
    "rota.publish","rota.approveSwap",
    "purchasing.approvePO","purchasing.receive",
    "recipes.cost","menu.editAllergens","labels.print",
    "incidents.report","incidents.close",
    "audits.perform","audits.publish",
    "recalls.trigger",
    "inspection.grantAccess",
  ],
  chef: [
    "haccp.editPlan","purchasing.receive","recipes.cost",
    "menu.editAllergens","labels.print","incidents.report",
    "audits.perform","recalls.trigger",
  ],
...
export const ACTION_GROUPS: Array<{ groupDe: string; groupEn: string; actions: Action[] }> = [
  { groupDe: "Nachweise & Aufzeichnungen", groupEn: "Records & evidence",
    actions: ["records.export","records.signOff","records.deleteLog"] },
  { groupDe: "HACCP", groupEn: "HACCP",
    actions: ["haccp.editPlan","haccp.approvePlan"] },
  { groupDe: "Team & Rollen", groupEn: "Team & roles",
    actions: ["team.manageRoles","team.invite"] },
  { groupDe: "Dienstplan", groupEn: "Rota",
    actions: ["rota.publish","rota.approveSwap"] },
  { groupDe: "Einkauf & Wareneingang", groupEn: "Purchasing & receiving",
    actions: ["purchasing.approvePO","purchasing.receive"] },
  { groupDe: "Küche & Menü", groupEn: "Kitchen & menu",
    actions: ["recipes.cost","menu.editAllergens","labels.print"] },
  { groupDe: "Vorfälle & Rückrufe", groupEn: "Incidents & recalls",
    actions: ["incidents.report","incidents.close","recalls.trigger"] },
  { groupDe: "Audits & Prüfung", groupEn: "Audits & inspection",
