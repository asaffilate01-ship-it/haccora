...
4. Run `npm run build:ios` and `npm run build:android` after Apple/Google signing, privacy declarations, screenshots, support URLs and store metadata are complete.
